"""Proyecto_Licorera_online URL Configuration
...
from Contacto.views import Datos_Entrega,Enviar_datos
...
urlpatterns = [
    ...
    path('Datos_Entrega/<int:pk>',Datos_Entrega),
    path('Enviar_datos/',Enviar_datos),
    path('shop/',shoop),
